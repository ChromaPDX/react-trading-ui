...
var DepthChart = function (_React$Component) {
  _inherits(DepthChart, _React$Component);

  function DepthChart() {
    _classCallCheck(this, DepthChart);

    return _possibleConstructorReturn(this, (DepthChart.__proto__ || Object.getPrototypeOf(DepthChart)).apply(this, arguments));
  }
